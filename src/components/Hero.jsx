...
const Hero = () => {
  ...
  <section className="bg-blue-800 text-white py-24">
    <div className="container mx-auto text-center px-4">
        ...
        <NavLink to="/profile" className="bg-white text-blue-800 hover:bg-blue-700 hover:text-white px-6 py-3 rounded-full font-semibold uppercase tracking-wide">Get Started</NavLink>
    </div>
  </section>
  )
}
